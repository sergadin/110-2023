...
int readLinesFromFile(const char *filename, char **lines, int max_length, int max_lines)
{
...
int find_difference(const char *filenameA, const char *filenameB, const char *fout, Error *error)
{
    ...
    int lineCountA = readLinesFromFile(filenameA, linesA, max_length, max_lines);
    int lineCountB = readLinesFromFile(filenameB, linesB, max_length, max_lines);
