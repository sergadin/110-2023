...
int main(void){
	double res, eps = 1e-5;
	Error err;
    //double matr1[1] = {1, 4}, matr2[4] = {2, 1, 0.5, -9, 2}, matr3[9] = {3, 1, 2, 3, 3, 2, 1, 4, 2, 5}, *matr4 = {0};
   // double matr5[36] = {6, 118, 146, 119, 140, 66, 142, 141, 75, 79, 76, 148, 3, 137, 51, 27, 23, 115, 110, 15, 126, 140, 36, 6, 56, 95, 20, 17, 124, 140, 94, 97, 131, 88, 148, 29, 36};
